...
![Página de inicio](./imgDAW/inici1.jpg)           
![Página de inicio](./imgDAW/inici2.jpg)              
...
![Detalles del producto](./imgDAW/producte.jpg)                
...
![Creación del producto](./imgDAW/creacio_producte.jpg)                  
...
![Recuperación de contraseña](./imgDAW/recuperacio_contrasenya.jpg)             
...
![Blog y notícias](./imgDAW/llista_articles.jpg)   
...
![Página de Inicio](./imgDAM/pInici1.jpg)             
...
![Catálogo de productos](./imgDAM/pCataleg.jpg)             
...
![Detalles del producto](./imgDAM/pDetallArticle.jpg)             
...
![Formulario para agregar producto](./imgDAM/pAfegirProducte.jpg)             
...
![Cesta de la Compr](./imgDAM/pCistella.jpg)             
...
En la página de pago (Checkout), el usuario podrá seleccionar el método de pago de su preferencia y proporcionar la dirección de envío. Una vez que haya completado esta información, podrá hacer clic en el botón para finalizar la compra.              
  ![Proceso de Compra](./imgDAM/pCheckout.jpg)             
...
![Inicio de Sesión](./imgDAM/pIniciSessio.jpg)             
...
En el formulario, encontrarás un botón para enviar la solicitud de recuperación y otro botón para volver a la página de inicio de sesión en caso de que desees cancelar el proceso.       
  ![Recuperación de Contraseña](./imgDAM/pRecuperarContrasenya.jpg)             
